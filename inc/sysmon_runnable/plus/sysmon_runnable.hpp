...
namespace sysmon_base
{
    ...
    class CSysmonBaseRunnable : public daddy::CRunnable
    {
        public:
            //class constructor 
            CSysmonBaseRunnable():m_taskMonReceiverPort(),m_taskMonAlgoReceiverPort(), m_sys_mon_base_senderport(),m_sysmon_R5toA53_senderport(), m_RomTestReceiverPort()
            {
            }
            ...
            daddy::TSenderPort<sysmon::CSysMonOutput> m_sysmon_R5toA53_senderport;
