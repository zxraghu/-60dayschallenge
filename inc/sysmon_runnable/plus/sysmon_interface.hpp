...
#include "sysmon_us/inc/sysmon/sysmon_d3_interface.hpp"
...
namespace sysmon
{
    ...
    class CSysMonD3Output : public daddy::CInterfaceBase
    {
        public:
        enum {     ID = 1 };
        enum {     VERSION = 1 };
        CsysMonD3Data     m_CsysMonD3Data;

        CSysMonD3Output() : daddy::CInterfaceBase(ID, VERSION),       
        m_CsysMonD3Data()
        {
